...
| Seta circular | Vórtice — redemoinho de água | 5 círculos concêntricos com seta direcional |
...
### Símbolo
As letras I·A·R·A sem o wordmark. Cada letra é construída com cinco paths concêntricos em stroke fino, com transição dourado→ciano. A luminosidade ao centro e a intensidade nas bordas remetem ao olhar de dentro da água para a superfície — a perspectiva da própria Iara.
...
| Dourada | `#BA9130` | Petróleo escuro → ciano |

Na versão dourada, o path externo recebe um contorno em petróleo escuro (`#192728`) que ancora a forma e garante legibilidade sobre o fundo saturado.
...
**Seta circular** — 5 círculos concêntricos com seta direcional. Deriva do conceito de vórtice fluvial — o redemoinho que a Iara usa para atrair. Disponível em ciano e dourado, com 3 estados cada. No estado hover, os círculos ganham preenchimento difuso (glow) que reforça a sensação de movimento centrípeto.
